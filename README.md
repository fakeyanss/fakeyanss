...
```text
Lua              19 hrs 59 mins  >>>>>>>>>>>>>>-----------   56.07 %
Java             8 hrs 31 mins   >>>>>>-------------------   23.91 %
XML              4 hrs           >>>----------------------   11.23 %
YAML             1 hr 14 mins    >------------------------   03.46 %
Other            22 mins         -------------------------   01.04 %
SQL              16 mins         -------------------------   00.75 %
```
...
- [usememos/memos](https://github.com/usememos/memos) - An open-source, self-hosted memo hub with knowledge management and social networking. (1 day ago)
- [giskook/vav-ms](https://github.com/giskook/vav-ms) - jt1078 音视频服务器 (1 day ago)
- [nshen/learn-neovim-lua](https://github.com/nshen/learn-neovim-lua) - Neovim 配置实战：从 0 到 1 打造自己的 IDE (4 days ago)
